...
<div align="center">
  ...
  **Final Year CSE Student | Aspiring AI & Blockchain Developer**
...
| **Blockchain & Web3** | ![Solana](https://img.shields.io/badge/Solana-00FFA3?style=for-the-badge&logo=solana&logoColor=black) ![Anchor](https://img.shields.io/badge/Anchor_Framework-663399?style=for-the-badge) ![Web3](https://img.shields.io/badge/Web3-F16822?style=for-the-badge)                                                |
...
An AI-powered platform that uses real-world challenges with AI feedback to validate skills. Achievements are awarded as NFT-based credentials on the Solana blockchain, with decentralized storage via IPFS.
...
A transparent medicine donation system connecting NGOs and donors. It uses a blockchain-based ledger for trust and an AI matching algorithm for optimal distribution of resources.
...
A context-aware chatbot built with a RAG pipeline to provide real-time campus information. It delivers smart, relevant responses to student queries.
...
An intelligent tool that generates clean, readable comments and documentation for code in multiple languages, powered by LLMs.
...
| Learning & Building                | Goals for the Near Future      |
| ---------------------------------- | ------------------------------ |
| - Advanced Rust Programming        | - Contribute to open source    |
| - Large Language Models & GenAI    | - Build impactful Web3 solutions |
| - Solana Program Development       | - Master system design patterns|
...
- 💻 Participated in **2 Global Hackathons** and **2 National-Level Hackathons**
...
My core principles are **Purpose-Driven Development**, **Clean Architecture**, **Performance First**, and **Continuous Learning**.
